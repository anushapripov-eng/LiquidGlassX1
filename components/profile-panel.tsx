...
const AVATARS = [
  { bg: "bg-gradient-to-br from-blue-500 to-blue-700", emoji: "📈", label: "Trader" },
  { bg: "bg-gradient-to-br from-emerald-500 to-emerald-700", emoji: "🐂", label: "Bull" },
  { bg: "bg-gradient-to-br from-orange-500 to-orange-700", emoji: "🦊", label: "Fox" },
  { bg: "bg-gradient-to-br from-rose-500 to-rose-700", emoji: "🐻", label: "Bear" },
  { bg: "bg-gradient-to-br from-violet-500 to-violet-700", emoji: "💎", label: "Pro" },
  { bg: "bg-gradient-to-br from-cyan-500 to-cyan-700", emoji: "🦈", label: "Shark" },
  { bg: "bg-gradient-to-br from-amber-500 to-amber-700", emoji: "💰", label: "Gold" },
  { bg: "bg-gradient-to-br from-pink-500 to-pink-700", emoji: "⚡", label: "Flash" },
]
