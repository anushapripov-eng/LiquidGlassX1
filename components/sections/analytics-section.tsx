  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {analytics.monthlyData.length > 0 && (
        <>
        <GlassCard className="p-4">
          <div className="text-sm font-medium text-foreground mb-3">Monthly Performance (% Gain)</div>
          <div className="h-48">
            <ResponsiveContainer width="100%" height="100%">
        ...
        <GlassCard className="p-4">
          <div className="text-sm font-medium text-foreground mb-3">Monthly Win Rate (%)</div>
          <div className="h-48">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={analytics.monthlyData}>
                <CartesianGrid strokeDasharray="3 3" stroke="oklch(0.5 0 0 / 0.1)" />
        ...
        <GlassCard className="p-4">
          <div className="text-sm font-medium text-foreground mb-3">Monthly Trade Count</div>
          <div className="h-48">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={analytics.monthlyData}>
                <CartesianGrid strokeDasharray="3 3" stroke="oklch(0.5 0 0 / 0.1)" />
