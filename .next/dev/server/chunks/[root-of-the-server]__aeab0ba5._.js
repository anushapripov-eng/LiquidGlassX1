...
const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(("TURBOPACK compile-time value", "https://cbnuokgmzvlmrtjiwigh.supabase.co"), process.env.SUPABASE_SERVICE_ROLE_KEY);
...
async function POST(request) {
    try {
        ...
        const { data: user, error } = await supabase.from("users").select("id, username, nickname, avatar_index, password_hash").eq("username", username).single();
        if (error || !user) {
...
async function PUT(request) {
    try {
        ...
        await supabase.from("rules").insert(defaultRules.map((text, i)=>({
                user_id: newUser.id,
                text,
                sort_order: i
            })));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aeab0ba5._.js.map