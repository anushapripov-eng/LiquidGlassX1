module.exports = [
"[project]/node_modules/node-telegram-bot-api/src/utils.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const util = __turbopack_context__.r("[externals]/util [external] (util, cjs)");
// Native deprecation warning
exports.deprecate = (msg)=>util.deprecate(()=>{}, msg, 'node-telegram-bot-api')();
}),
"[project]/node_modules/node-telegram-bot-api/lib/errors.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/node-telegram-bot-api/lib/telegramWebHook.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var debug = __turbopack_context__.r("[project]/node_modules/debug/src/index.js [app-route] (ecmascript)")('node-telegram-bot-api');
...
"[project]/node_modules/node-telegram-bot-api/lib/utils.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/node-telegram-bot-api/lib/telegramPolling.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/node-telegram-bot-api/lib/telegram.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var debug = __turbopack_context__.r("[project]/node_modules/debug/src/index.js [app-route] (ecmascript)")('node-telegram-bot-api');
var EventEmitter = __turbopack_context__.r("[project]/node_modules/node-telegram-bot-api/node_modules/eventemitter3/index.js [app-route] (ecmascript)");
...
var TelegramBot = function(_EventEmitter) {
   ...
   */ _createClass(TelegramBot, [
        ...
        },
        {
            ...
            value: function _fixAddFileThumbnail(options, opts) {
                ...
                if (options.thumbnail) {
                    ...
                    var _formatSendData2 = this._formatSendData(attachName, options.thumbnail.replace('attach://', '')), _formatSendData3 = _slicedToArray(_formatSendData2, 1), formData = _formatSendData3[0];
                    if (formData) {
        ...
        {
            key: '_fixMessageIds',
            value: function _fixMessageIds(obj) {
                var messageIds = obj.message_ids;
       ...
       * consistency of the method signatures throughout the library */ var cert = void 0;
        ...
        },
        {
            ...
            value: function sendPaidMedia(chatId, starCount, media) {
                ...
                try {
                    var inputPaidMedia = [];
                    opts.formData = {};
                    var _formatSendMultipleDa = this._formatSendMultipleData('media', media), formData = _formatSendMultipleDa.formData, fileIds = _formatSendMultipleDa.fileIds;
        ...
        },
        {
            ...
            value: function sendChecklist(businessConnectionId, chatId, checklist) {
                ...
                return this._request('sendChecklist', {
                    form: form
                });
            }
        },
       ...
       * consistency of the method signatures throughout the library */ if ((typeof form === 'undefined' ? 'undefined' : _typeof(form)) !== 'object') {
        ...
        },
        {
            ...
            value: function setUserEmojiStatus(userId) {
                var form = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
                form.user_id = userId;
                return this._request('setUserEmojiStatus', {
                    form: form
                });
            }
        },
        ...
        },
        {
            ...
            value: function createChatSubscriptionInviteLink(chatId, subscriptionPeriod, subscriptionPrice) {
                ...
                return this._request('createChatSubscriptionInviteLink', {
                    form: form
                });
            }
        },
        {
            ...
            value: function editChatSubscriptionInviteLink(chatId, inviteLink) {
                ...
                form.chat_id = chatId;
                form.invite_link = inviteLink;
                return this._request('editChatSubscriptionInviteLink', {
                    form: form
                });
            }
        },
       ...
       * consistency of the method signatures throughout the library. */ if ((typeof callbackQueryId === 'undefined' ? 'undefined' : _typeof(callbackQueryId)) === 'object') {
        ...
        },
        {
            ...
            value: function savePreparedInlineMessage(userId, result) {
                ...
                return this._request('savePreparedInlineMessage', {
                    form: form
                });
            }
        },
        ...
        },
        {
            ...
            value: function editMessageChecklist(businessConnectionId, chatId, messageId, checklist) {
                ...
                form.message_id = messageId;
                form.checklist = stringify(checklist);
                return this._request('editMessageChecklist', {
                    form: form
                });
            }
        },
        ...
        },
        {
            ...
            value: function getMyStarBalance() {
                var form = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
                return this._request('getMyStarBalance', {
                    form: form
                });
            }
        },
        {
            ...
            value: function getStarTransactions() {
                var form = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
                return this._request('getStarTransactions', {
                    form: form
                });
            }
        },
        {
            ...
            value: function refundStarPayment(userId, telegramPaymentChargeId) {
                ...
                return this._request('refundStarPayment', {
                    form: form
                });
            }
        },
        {
            ...
            value: function editUserStarSubscription(userId, telegramPaymentChargeId, isCanceled) {
                ...
                return this._request('editUserStarSubscription', {
                    form: form
                });
            }
        },
        ...
        },
        {
            ...
            value: function getAvailableGifts() {
                var form = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
                return this._request('getAvailableGifts', {
                    form: form
                });
            }
        },
        ...
        },
        {
            ...
            value: function giftPremiumSubscription(userId, monthCount, starCount) {
                ...
                return this._request('giftPremiumSubscription', {
                    form: form
                });
            }
        },
        {
            ...
            value: function verifyUser(userId) {
                var form = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
                form.user_id = userId;
                return this._request('verifyUser', {
                    form: form
                });
            }
        },
        {
            ...
            value: function verifyChat(chatId) {
                var form = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
                form.chat_id = chatId;
                return this._request('verifyChat', {
                    form: form
                });
            }
        },
        ...
        },
        {
            ...
            value: function removeChatVerification(chatId) {
                var form = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
                form.chat_id = chatId;
                return this._request('removeChatVerification', {
                    form: form
                });
            }
        },
        {
            ...
            value: function readBusinessMessage(businessConnectionId, chatId, messageId) {
                ...
                form.chat_id = chatId;
                form.message_id = messageId;
                return this._request('readBusinessMessage', {
                    form: form
                });
            }
        },
        {
            ...
            value: function deleteBusinessMessages(businessConnectionId, messageIds) {
                ...
                form.business_connection_id = businessConnectionId;
                form.message_ids = stringify(messageIds);
                return this._request('deleteBusinessMessages', {
                    form: form
                });
            }
        },
        {
            ...
            value: function setBusinessAccountName(businessConnectionId, firstName) {
                ...
                form.business_connection_id = businessConnectionId;
                form.first_name = firstName;
                return this._request('setBusinessAccountName', {
                    form: form
                });
            }
        },
        {
            ...
            value: function setBusinessAccountUsername(businessConnectionId) {
                var form = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
                form.business_connection_id = businessConnectionId;
                return this._request('setBusinessAccountUsername', {
                    form: form
                });
            }
        },
        {
            ...
            value: function setBusinessAccountBio(businessConnectionId) {
                var form = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
                form.business_connection_id = businessConnectionId;
                return this._request('setBusinessAccountBio', {
                    form: form
                });
            }
        },
        ...
        },
        {
            ...
            value: function removeBusinessAccountProfilePhoto(businessConnectionId) {
                var form = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
                form.business_connection_id = businessConnectionId;
                return this._request('removeBusinessAccountProfilePhoto', {
                    form: form
                });
            }
        },
        {
            ...
            value: function setBusinessAccountGiftSettings(businessConnectionId, showGiftButton, acceptedGiftTypes) {
                ...
                return this._request('setBusinessAccountGiftSettings', {
                    form: form
                });
            }
        },
        ...
        },
        {
            ...
            value: function transferBusinessAccountStars(businessConnectionId, startCount) {
                ...
                return this._request('transferBusinessAccountStars', {
                    form: form
                });
            }
        },
        {
            ...
            value: function getBusinessAccountGifts(businessConnectionId) {
                var form = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
                form.business_connection_id = businessConnectionId;
                return this._request('getBusinessAccountGifts', {
                    form: form
                });
            }
        },
        {
            ...
            value: function convertGiftToStars(businessConnectionId, ownedGiftId) {
                ...
                return this._request('convertGiftToStars', {
                    form: form
                });
            }
        },
        {
            ...
            value: function upgradeGift(businessConnectionId, ownedGiftId) {
                ...
                form.business_connection_id = businessConnectionId;
                form.owned_gift_id = ownedGiftId;
                return this._request('upgradeGift', {
                    form: form
                });
            }
        },
        {
            ...
            value: function transferGift(businessConnectionId, ownedGiftId, newOwnerChatId) {
                ...
                return this._request('transferGift', {
                    form: form
                });
            }
        },
        {
            ...
            value: function postStory(businessConnectionId, content, activePeriod) {
                ...
                try {
                    ...
                    var _formatSendMultipleDa2 = this._formatSendMultipleData(content.type, [
                        content
                    ]), formData = _formatSendMultipleDa2.formData, fileIds = _formatSendMultipleDa2.fileIds;
                    opts.formData = formData;
                    if (fileIds[0]) {
        ...
        },
        {
            ...
            value: function editStory(businessConnectionId, storyId, content) {
                ...
                try {
                    ...
                    var _formatSendMultipleDa3 = this._formatSendMultipleData(content.type, [
                        content
                    ]), formData = _formatSendMultipleDa3.formData, fileIds = _formatSendMultipleDa3.fileIds;
                    opts.formData = formData;
                    if (fileIds[0]) {
                        inputHistoryContent[content.type] = fileIds[0];
                    } else {
        ...
        },
        {
            ...
            value: function deleteStory(businessConnectionId, storyId) {
                ...
                return this._request('deleteStory', {
                    form: form
                });
            }
        }
...
"[project]/node_modules/node-telegram-bot-api/src/errors.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/node-telegram-bot-api/src/telegramWebHook.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const errors = __turbopack_context__.r("[project]/node_modules/node-telegram-bot-api/src/errors.js [app-route] (ecmascript)");
const debug = __turbopack_context__.r("[project]/node_modules/debug/src/index.js [app-route] (ecmascript)")('node-telegram-bot-api');
...
"[project]/node_modules/node-telegram-bot-api/src/telegramPolling.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/node-telegram-bot-api/src/telegram.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
const debug = __turbopack_context__.r("[project]/node_modules/debug/src/index.js [app-route] (ecmascript)")('node-telegram-bot-api');
const EventEmitter = __turbopack_context__.r("[project]/node_modules/node-telegram-bot-api/node_modules/eventemitter3/index.js [app-route] (ecmascript)");
...
"[project]/node_modules/node-telegram-bot-api/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
//# sourceMappingURL=node_modules_node-telegram-bot-api_ab6b7669._.js.map